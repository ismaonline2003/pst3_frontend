...
export default function EmisionesAudio({}) {
    ...
    return (
        <React.Fragment>
            ...
            <br />
            <SearchBar selectOptions={searchBarParameters} externalHandleSearchBtn={handleSearchBtn} crearRoute={"/dashboard/emisionesAudio/0"} searchSelectValues={searchSelectValues}/>
            <br />
                                ...
                                <TableRow
                                    ...
                                    >
                                        ...
                                        <TableCell align="left">
                                            <Link to={`/dashboard/emisionesAudio/${row.id}`}>
