...
export default function CategoriasNoticias({}) {
    ...
    const searchRecords = (searchVals) => {
        ...
        let url = `${consts.backend_base_url}/api/categoria_noticia?limit=${searchVals.limit}`;
    ...
    return (
        <React.Fragment>
            <br /> 
            <StyledH1>Categorías de Noticias</StyledH1>
            <br />
            <SearchBar selectOptions={searchBarParameters} externalHandleSearchBtn={handleSearchBtn} crearRoute={"/dashboard/categorias_noticias/0"} searchSelectValues={searchSelectValues}/>
            <br />
                                    ...
                                    <TableRow
                                        ...
                                        >
                                            ...
                                            <TableCell align="left">
                                                <Link to={`/dashboard/categorias_noticias/${row.id}`}>
