...
const ProfesorForm = ({}) => {
    ...
    const [gradoInstruccion, setGradoInstruccion] = useState(undefined);
    ...
    const searchEstudiante = () => {
        ...
        if(id != "0") {
            ...
            let url = `${consts.backend_base_url}/api/profesor/${id}`;
            axios.get(url, config).then((response) => {
                ...
                setGradoInstruccion(response.data.grado_instruccion);
    ...
    const createEstudiante = () => {
        ...
        formData.append('data', JSON.stringify(body));
        const config = {headers:{'authorization': token, 'Content-Type': 'multipart/form-data'}};
        let url = `${consts.backend_base_url}/api/profesor`;
    ...
    const _resetEstudianteData = () => {
        ...
        setGradoInstruccion(estudiante.grado_instruccion);
        ...
        <div className='m-4'>
            {
                ...
                <div className='text-center mb-10'>
                    <StyledH1>Crear un nuevo Profesor</StyledH1>
                </div>
            }
            {
                id != '0' && estudianteFound &&
                <div className='text-center mb-10'>
                    <StyledH1>Actualizar Profesor</StyledH1>
                </div>
            }
            {
            ...
            {
                reLoad && <Navigate to={`/dashboard/profesores/${newId}`} />
            }
            {
                redirect && <Navigate to="/dashboard/profesores" />
            }
            {
                estudianteFound && 
                <FormContainer>
                    ...
                    <div className='d-flex flex-row flex-wrap'>
                    {
                        ...
                        <FormControl sx={{ m: 1, width: '95%' }} variant="outlined">
                            <TextField id="grado_instruccion" select label="Grado Instrucción" 
                                defaultValue={gradoInstruccion ? gradoInstruccion : "5"} 
                                onChange={(e) => setGradoInstruccion(e.target.value)}
                            >
                                {gradosInstruccion.map((option) => (
            ...
            }            
            {
                ...
                <FormContainer>
                    <div className='text-center'>
                        ...
                        <StyledH2 className='mt-5'>El profesor no fue encontrado</StyledH2>
